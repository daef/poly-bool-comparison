...
request.onload = function() {
    if (request.status >= 200 && request.status < 400) {
        ...
        const combatants = ['martinez_cgal', 'martinez_cpp', 'milevski', 'podloznuk', 'voidqk', 'rust-geo-booleanop']
...
var CreateContext = function() {
    ...
    this.combatants = ['martinez_cgal', 'martinez_cpp', 'milevski', 'podloznuk', 'voidqk', 'rust-geo-booleanop']
